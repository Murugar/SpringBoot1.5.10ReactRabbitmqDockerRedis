  ...
  render() {
    ...
    return (
      <div className="container bg-warning">
        <br/>
        <br/>
        <PageHeader className="text-primary">Customers
          <pre>Total Number of Customers :<Badge className="label-danger bg-success">{this.props.page.totalElements}</Badge></pre>
        </PageHeader>
        <br/>
        ...
        <Table striped bordered condensed hover>
          <thead>
            <tr className="danger text-warning">
          ...
          <tbody className="success text-primary">
            {customers}
